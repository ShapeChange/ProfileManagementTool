                                ...
                                <Popover placement="bottom right"
                                    ...
                                    <PopoverContent className="p-0" style={{ overflowY: 'auto', maxHeight: '400px' }}>
                                        <ListGroup className="border-0 rounded-0">
                                            {model.profilesInfo[profile].errors.map((err, i) => <ListGroupItem key={err._id} className={`rounded-0 border-left-0 border-right-0 border-bottom-0 ${i === 0 && 'border-top-0'}`}>
