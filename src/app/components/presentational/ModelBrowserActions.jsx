...
class ModelBrowserActions extends Component {
    ...
    render() {
        const {_id, name, type} = this.props;
            ...
            <div>
                <FormGroup tag="fieldset">
                    <Toggle name="includeSelf"
                        checked={ this.state.checked.includeSelf || false }
                        onToggle={ this._toggle }
                        size="2x">
                        <span className="align-self-center"><span className="font-italic">{ name }</span> is included in profile</span>
                    </Toggle>
                    { isPackage &&
